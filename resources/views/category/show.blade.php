            ...
            <div class="modal-content">
                ...
                <form class="w-100" id="form" method="post" action="">
                    <div class="modal-body">
                        @csrf
                        <x-input id="name" name="name" wrapper-class="w-100" label-top label="Наименование:"
                                 autofocus required/>
            ...
            <div class="modal-content">
                ...
                <form class="w-100" id="form" method="post" action="">
                    <div class="modal-body">
                        ...
                        <x-input id="name" name="name" wrapper-class="w-100" class="" label-top label="Наименование:"
                                 autofocus required/>
                        <div class="modal-footer p-0 mt-2" style="border-top: none">
