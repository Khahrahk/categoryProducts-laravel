        ...
        <div class="content col-6 h-100" style="min-width: 300px; max-width: 500px;">
                <div class="login-island" style="padding-top: 50%">
                    <form method="POST" action="{{ route("login_process") }}" class="card w-100">
                        <h5 class="card-header d-flex flex-column align-items-center justify-content-center">Вход</h5>
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex flex-row py-3">
                                <x-button link primary :href="route('register')" label="Зарегестрироваться" />
                            </div>
                            <div class="d-flex flex-column action">
                                <x-button outline primary label="Подтвердить" type="submit" />
                            </div>
                        </div>
                    </form>
                </div>
